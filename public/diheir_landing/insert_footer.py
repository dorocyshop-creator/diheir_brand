...
<!-- ══ 새 풋터 ══════════════════════════════════════════ -->
<footer class="relative w-full bg-[#383629] px-[8vw] md:px-[80px] lg:px-[120px] py-[10vw] md:py-[100px] flex flex-col md:flex-row justify-between items-start md:items-end gap-10 md:gap-0" data-name="footer">
...
html = html.replace('</section>', new_footer, 1)
