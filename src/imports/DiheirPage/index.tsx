...
function Logo() {
  return (
    <div
      className="absolute h-[186px] left-[660px] top-[447px] w-[600px]"
      data-name="logo"
    >
      <svg
      ...
      >
        <g clipPath="url(#clip0_1_451)" id="logo">
          <g id="Group">
            ...
            />
            <path
              d={svgPaths.p2525ea00}
              fill="var(--fill-0, white)"
              id="Vector_2"
            />
            <path
              d={svgPaths.p14319500}
              fill="var(--fill-0, white)"
              id="Vector_3"
            />
          </g>
          ...
          />
          <path
            d={svgPaths.p21087400}
            fill="var(--fill-0, white)"
            id="Vector_5"
          />
          <g id="Group_2">
            <path
              d={svgPaths.p2e414e80}
              fill="var(--fill-0, white)"
              id="Vector_6"
            />
            <path
              d={svgPaths.p3b659400}
              fill="var(--fill-0, white)"
              id="Vector_7"
            />
          </g>
          <path
            d={svgPaths.p11f0e600}
            fill="var(--fill-0, white)"
            id="Vector_8"
          />
          <path
            d={svgPaths.p254aa200}
            fill="var(--fill-0, white)"
            id="Vector_9"
          />
        </g>
  ...
  return (
    <div className="absolute inset-[0_0_32.23%_0]" data-name="Group">
      ...
      >
        <g id="Group">
          <path
            d={svgPaths.p2451eb00}
            fill="var(--fill-0, #383629)"
            id="Vector"
          />
          <path
            d={svgPaths.p770c80}
          ...
          />
          <path
            d={svgPaths.p1e123b80}
            fill="var(--fill-0, #383629)"
            id="Vector_3"
          />
          <path
            d={svgPaths.p2ad0df40}
            fill="var(--fill-0, #383629)"
            id="Vector_4"
          />
          <path
            d={svgPaths.p2ce67480}
            fill="var(--fill-0, #383629)"
            id="Vector_5"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p2285c600}
            fill="var(--fill-0, #383629)"
            id="Vector_9"
          />
          <path
            d={svgPaths.p3b9bfe00}
            fill="var(--fill-0, #383629)"
            id="Vector_10"
          />
          <path
            d={svgPaths.p1d80da00}
            fill="var(--fill-0, #383629)"
            id="Vector_11"
          />
          <path
            d={svgPaths.p22c49a00}
            fill="var(--fill-0, #383629)"
            id="Vector_12"
          />
          <path
            d={svgPaths.p3460d300}
            fill="var(--fill-0, #383629)"
            id="Vector_13"
          />
          <path
            d={svgPaths.p20af1a00}
            fill="var(--fill-0, #383629)"
            id="Vector_14"
          />
          <path
            d={svgPaths.p3d657400}
            fill="var(--fill-0, #383629)"
            id="Vector_15"
          />
          <path
            d={svgPaths.p30586300}
            fill="var(--fill-0, #383629)"
            id="Vector_16"
          />
          <path
            d={svgPaths.p13db9600}
            fill="var(--fill-0, #383629)"
            id="Vector_17"
          />
          <path
            d={svgPaths.p18371500}
            fill="var(--fill-0, #383629)"
            id="Vector_18"
          />
          <path
            d={svgPaths.p296f3900}
            fill="var(--fill-0, #383629)"
            id="Vector_19"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p3847a140}
            fill="var(--fill-0, #383629)"
            id="Vector_25"
          />
          <path
            d={svgPaths.p194ffb00}
            fill="var(--fill-0, #383629)"
            id="Vector_26"
          />
          <path
            d={svgPaths.p2fc1a000}
            fill="var(--fill-0, #383629)"
            id="Vector_27"
          />
          <path
            d={svgPaths.p106a7900}
            fill="var(--fill-0, #383629)"
            id="Vector_28"
          />
          <path
            d={svgPaths.p39745880}
            fill="var(--fill-0, #383629)"
            id="Vector_29"
          />
          <path
            d={svgPaths.p2bc5a800}
            fill="var(--fill-0, #383629)"
            id="Vector_30"
          />
          <path
            d={svgPaths.p178e4000}
            fill="var(--fill-0, #383629)"
            id="Vector_31"
          />
          <path
            d={svgPaths.p1237f900}
            fill="var(--fill-0, #383629)"
            id="Vector_32"
          />
          <path
            d={svgPaths.p17e0bb00}
            fill="var(--fill-0, #383629)"
            id="Vector_33"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p360f8f00}
            fill="var(--fill-0, #383629)"
            id="Vector_35"
          />
          <path
            d={svgPaths.p10576900}
            fill="var(--fill-0, #383629)"
            id="Vector_36"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p2fc62800}
            fill="var(--fill-0, #383629)"
            id="Vector_41"
          />
          <path
            d={svgPaths.p3e68b6f0}
            fill="var(--fill-0, #383629)"
            id="Vector_42"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p172c9980}
            fill="var(--fill-0, #383629)"
            id="Vector_44"
          />
          <path
            d={svgPaths.p39f7bb80}
            fill="var(--fill-0, #383629)"
            id="Vector_45"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p1d5bea00}
            fill="var(--fill-0, #383629)"
            id="Vector_51"
          />
          <path
            d={svgPaths.p20021f80}
            fill="var(--fill-0, #383629)"
            id="Vector_52"
          />
          <path
            d={svgPaths.p115a2400}
            fill="var(--fill-0, #383629)"
            id="Vector_53"
          />
          <path
            d={svgPaths.p1e162980}
            fill="var(--fill-0, #383629)"
            id="Vector_54"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p391c4b00}
            fill="var(--fill-0, #383629)"
            id="Vector_58"
          />
          <path
            d={svgPaths.p1a2b2d80}
            fill="var(--fill-0, #383629)"
            id="Vector_59"
          />
          <path
            d={svgPaths.p26bfed00}
            fill="var(--fill-0, #383629)"
            id="Vector_60"
          />
        </g>
...
function Group2() {
  return (
    <div
      className="absolute inset-[63.37%_43.25%_3.96%_35.13%]"
      data-name="Group"
    >
      <svg
        className="absolute block inset-0 size-full"
...
function Group3() {
  return (
    <div
      className="absolute inset-[73.12%_41.64%_1.85%_38.52%]"
      data-name="Group"
    >
      <svg
        className="absolute block inset-0 size-full"
      ...
      >
        <g id="Group">
          ...
          />
          <path
            d={svgPaths.p1630ef00}
            fill="var(--fill-0, #383629)"
            id="Vector_5"
          />
          <path
            d={svgPaths.p1f901900}
            fill="var(--fill-0, #383629)"
            id="Vector_6"
          />
          <path
          ...
          />
          <path
            d={svgPaths.p35e70b00}
            fill="var(--fill-0, #383629)"
            id="Vector_8"
          />
          <path
            d={svgPaths.p37161200}
            fill="var(--fill-0, #383629)"
            id="Vector_9"
          />
          <path
...
function Group4() {
  return (
    <div
      className="absolute inset-[80.09%_34.96%_1.7%_34.48%]"
      data-name="Group"
    >
      <svg
        className="absolute block inset-0 size-full"
      ...
      >
        <g id="Group">
          <path
            d={svgPaths.p31999880}
            fill="var(--fill-0, #383629)"
            id="Vector"
          />
          <path
            d={svgPaths.p15ce8800}
            fill="var(--fill-0, #383629)"
            id="Vector_2"
          />
          <path
            d={svgPaths.p32103400}
            fill="var(--fill-0, #383629)"
            id="Vector_3"
          />
          <path
            d={svgPaths.p374418f0}
            fill="var(--fill-0, #383629)"
            id="Vector_4"
          />
        </g>
...
function Group5() {
  return (
    <div
      className="absolute inset-[6.75%_3.11%_-0.01%_1.16%]"
      data-name="Group"
    >
      <svg
        className="absolute block inset-0 size-full"
...
function Layer() {
  return (
    <div
      className="h-[177px] opacity-30 overflow-clip relative shrink-0 w-[193px]"
      data-name="Layer_1"
    >
      <Group />
      <Group4 />
      ...
      >
        <g clipPath="url(#clip0_1_366)" id="Layer_1" opacity="0.3">
          <g id="Group">
            ...
            />
            <path
              d={svgPaths.p316fa080}
              fill="var(--fill-0, #383629)"
              id="Vector_2"
            />
            <path
              d={svgPaths.p2612d700}
              fill="var(--fill-0, #383629)"
              id="Vector_3"
            />
          </g>
          ...
          <g id="Group_2">
            <path
              d={svgPaths.p32a84f80}
              fill="var(--fill-0, #383629)"
              id="Vector_6"
            />
            <path
              d={svgPaths.p182bab80}
              fill="var(--fill-0, #4D4D4D)"
              id="Vector_7"
            />
          </g>
          <path
            d={svgPaths.p3ed06400}
            fill="var(--fill-0, #383629)"
            id="Vector_8"
          />
          <path
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center relative shrink-0 w-[388px]">
      <Frame9 />
      <p className="[word-break:break-word] capitalize font-dream leading-[1.3] not-italic opacity-30 relative shrink-0 text-[#383629] text-[30px] text-center tracking-[-0.6px] w-full">
...
function BrandIdentity() {
  return (
    <div
      id="brand"
      className="bg-[#f7f7ec] h-[2756px] overflow-clip relative shrink-0 w-[1920px] light-section"
      data-name="brand_identity"
    >
      <p className="[word-break:break-word] absolute capitalize font-dream leading-none left-[25px] not-italic text-[300px] text-[rgba(189,190,167,0.2)] top-[2088px] tracking-[-6px] whitespace-nowrap">
        Timeless
      </p>
      <p className="[word-break:break-word] absolute capitalize font-dream leading-none left-[360px] not-italic text-[300px] text-[rgba(189,190,167,0.2)] top-[2406px] tracking-[-6px] whitespace-nowrap">
        Green Grove
      </p>
      <div
        className="absolute h-[634px] left-[172px] top-[226px] w-[1748px]"
        data-name="Diheir_Logo_og 1"
      >
        <img
          alt=""
          className="absolute inset-0 max-w-none object-cover opacity-24 pointer-events-none size-full"
      ...
      <FadeUp className="absolute h-[1030px] left-[100px] top-[710px] w-[774px]">
        <div className="size-full" data-name="image 40">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img
              alt=""
              className="absolute h-[112.84%] left-0 max-w-none top-0 w-full"
              src={imgImage40}
            />
          </div>
        </div>
      ...
      <FadeUp
        delay={0.1}
        className="[word-break:break-word] absolute capitalize font-serif leading-[0] left-[100px] not-italic text-[#383629] text-[0px] top-[200px] whitespace-nowrap"
      >
        <span className="leading-[normal] text-[220px]">D</span>
        <span className="leading-[normal] text-[#bdbea7] text-[220px]">
          iamond
        </span>
      </FadeUp>
      <FadeUp
        delay={0.2}
        className="[word-break:break-word] absolute capitalize font-serif leading-[0] left-[807px] not-italic text-[#383629] text-[0px] top-[420px] whitespace-nowrap"
      >
      ...
      <FadeUp
        delay={0.2}
        className="[word-break:break-word] absolute capitalize font-sans leading-[0] left-[914px] not-italic text-[#383629] text-[22px] top-[1009px] tracking-[-0.44px] whitespace-nowrap"
      >
      ...
      <FadeUp
        delay={0.3}
        className="[word-break:break-word] absolute capitalize font-sans leading-[0] left-[100px] not-italic text-[#383629] text-[22px] top-[1886px] tracking-[-0.44px] whitespace-nowrap"
      >
        <p className="leading-[1.5] mb-0">
          보석은 단순한 장신구가 아니라 가족의 역사와 사랑의 시간을 담아
        </p>
        <p className="leading-[1.5]">
      ...
      <FadeUp
        delay={0.2}
        className="absolute left-[598px] size-[448px] top-[1438px]"
      >
...
function Frame4() {
  return (
    <div className="[word-break:break-word] capitalize content-stretch flex flex-col gap-[8px] items-start justify-center leading-[1.1] not-italic relative shrink-0 w-full">
      <p className="font-serif relative shrink-0 text-[#efefe1] text-[40px] tracking-[-0.8px] w-full">
        3st Generation
      </p>
      <p className="font-sans relative shrink-0 text-[#d4d4b9] text-[16px] tracking-[-0.32px] w-full">
        3남매의 도로시(1등 주얼리 쇼핑몰)
      </p>
...
function Frame5() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] relative rounded-tl-[20px] rounded-tr-[20px] shrink-0 w-full">
      <div
        aria-hidden
        className="absolute border border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none rounded-tl-[20px] rounded-tr-[20px]"
      />
...
function Frame6() {
  return (
    <FadeUp
      delay={0.2}
      className="-translate-x-1/2 absolute content-stretch flex flex-col h-[600px] items-center justify-end left-1/2 pt-[424px] top-[588px] w-[560px]"
    >
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-[100.03%] left-[-13.85%] max-w-none top-[-1.39%] w-[150.04%]"
            src={imgFrame9}
          />
        </div>
        <img
...
function Frame12() {
  return (
    <div className="[word-break:break-word] capitalize content-stretch flex flex-col gap-[8px] items-start justify-center leading-[1.1] not-italic relative shrink-0 w-full">
      ...
      <p className="font-sans font-light relative shrink-0 text-[#d4d4b9] text-[12px] tracking-[-0.24px] w-full">
        Donggwangdang Jewelry (Dongdaemun)
      </p>
    </div>
  );
}
...
function Frame7() {
  return (
    <FadeUp
      delay={0.1}
      className="absolute content-stretch flex flex-col h-[482px] items-center justify-end left-[150px] pt-[424px] top-[739px] w-[450px]"
    >
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            className="absolute h-[153.71%] left-[-1.13%] max-w-none top-[-15.74%] w-[102.9%]"
            src={imgFrame11}
          />
        </div>
        <div className="absolute bg-gradient-to-b from-[65.017%] from-[rgba(0,0,0,0)] inset-0 to-[rgba(0,0,0,0.6)]" />
...
function Frame15() {
  return (
    <div className="[word-break:break-word] capitalize content-stretch flex flex-col gap-[8px] items-start justify-center not-italic relative shrink-0 w-full">
      <p className="font-serif leading-[1.1] relative shrink-0 text-[#efefe1] text-[40px] tracking-[-0.8px] w-full">
        2st Generation
      </p>
      <p className="font-sans leading-[1.1] relative shrink-0 text-[#d4d4b9] text-[16px] tracking-[-0.32px] w-full">
        부모님의 삼정사(대구 교동시장 1호 금방)
      </p>
...
function Frame13() {
  return (
    <FadeUp
      delay={0.3}
      className="absolute content-stretch flex flex-col h-[482px] items-center justify-end left-[1320px] pt-[424px] top-[739px] w-[450px]"
    >
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <img
          alt=""
...
function BrandHeritage() {
  return (
    ...
    >
      <p className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-serif leading-[1.3] left-[calc(50%+576.5px)] not-italic opacity-24 text-[#bdbea7] text-[340px] text-center top-[401px] whitespace-nowrap">
        years
      </p>
      <p className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-serif leading-[1.3] left-[calc(50%-533px)] not-italic opacity-24 text-[#bdbea7] text-[820px] text-center top-[-31px] tracking-[-41px] whitespace-nowrap">
        80
      </p>
      ...
      <FadeUp
        delay={0.2}
        className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-dream leading-[1.3] left-[calc(50%+14.5px)] not-italic text-[rgba(159,159,139,0.24)] text-[220px] text-center top-[1448px] tracking-[-4.4px] whitespace-nowrap"
      >
        DIHEIR by DOROCY
      </FadeUp>
      <FadeUp
        delay={0.3}
        className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-sans leading-[1.6] left-[calc(50%+0.5px)] not-italic text-[#383629] text-[24px] text-center top-[1756px] tracking-[-0.48px] whitespace-nowrap"
      >
      ...
      <div className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-sans leading-[0] left-[calc(50%-0.5px)] not-italic text-[#383629] text-[24px] text-center top-[2036px] tracking-[-0.48px] whitespace-nowrap">
        <p className="leading-[1.5] mb-0 font-normal">
...
function ServicesDesigner() {
  return (
    <div
      id="services"
      className="bg-[#f7f7ec] h-[2550px] relative shrink-0 w-[1920px] light-section"
    ...
    >
      <div className="absolute h-[1224px] left-[calc(50%-2000px)] top-0 w-[4000px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img
            alt=""
            className="absolute h-full left-1/2 -translate-x-1/2 min-w-[1920px] w-full object-cover top-0"
            src={imgService}
          />
        </div>
      </div>
      <FadeUp className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-dream leading-[1.3] left-[calc(50%-489.5px)] not-italic text-[rgba(159,159,139,0.45)] text-[230px] text-center top-[72px] tracking-[-4.6px] whitespace-nowrap">
        High-End
      </FadeUp>
      <FadeUp
        delay={0.2}
        className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-dream leading-[1.3] left-[450px] not-italic text-[#383629] text-[60px] text-center top-[222px] tracking-[-1.2px] whitespace-nowrap"
      >
        Personal Design Consultation
      </FadeUp>
      <FadeUp
        delay={0.3}
        className="[word-break:break-word] absolute capitalize font-sans leading-[0] left-[calc(50%-2px)] not-italic text-[#383629] text-[18px] top-[198px] tracking-[-0.36px] whitespace-nowrap"
      >
      ...
      <FadeUp
        duration={1.0}
        className="absolute bg-[rgba(160,160,160,0.2)] border-2 border-[rgba(255,255,255,0)] border-solid h-[600px] left-[360px] rounded-[32px] top-[371px] w-[1200px]"
      />
      <FadeUp
        duration={1.0}
        delay={0.1}
        className="-translate-x-1/2 absolute h-[520px] left-1/2 rounded-[40px] top-[411px] w-[1082px] overflow-hidden bg-black/10"
      >
        <iframe
      ...
      <FadeUp
        delay={0.2}
        className="-translate-x-1/2 [word-break:break-word] absolute capitalize font-dream leading-[1.3] left-[calc(50%+161.5px)] not-italic opacity-80 text-[#f7f7ec] text-[230px] text-center top-[968px] tracking-[-4.6px] whitespace-nowrap"
      >
        Quality Jewelry
      </FadeUp>
    </div>
...
function Frame29() {
  return (
    <FadeUp
      delay={0.2}
      className="[word-break:break-word] capitalize content-stretch flex flex-col gap-[22px] items-center not-italic relative shrink-0 text-[#e7e8cf] text-center w-[1042px]"
    >
      ...
      <p className="font-sans leading-[1.3] relative shrink-0 text-[32px] tracking-[-0.64px] w-full">
...
function Group6({
  ...
  return (
    <div className="absolute contents">
      ...
      />
      <motion.div
        style={{ x: rightX, top: rightTopY }}
        className="absolute h-[360px] left-[1515px] w-[600px]"
      >
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-[#d9d9d9] inset-0" />
      ...
      <motion.div
        style={{ x: rightX, top: rightBottomY }}
        className="absolute h-[360px] left-[1515px] w-[600px]"
      >
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-[#d9d9d9] inset-0" />
      ...
      <motion.div
        style={{ x: leftX, top: leftTopY }}
        className="absolute h-[360px] left-[-187px] w-[600px]"
      >
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          <div className="absolute bg-[#d9d9d9] inset-0" />
          <div className="absolute inset-0 overflow-hidden flex items-center justify-center">
...
function Frame31() {
  return (
    <FadeUp
      delay={0.1}
      className="absolute content-stretch flex items-center justify-center left-[560px] p-[10px] top-0"
    >
      <div className="h-[584px] relative shrink-0 w-[540px]">
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <img
              alt=""
              className="absolute h-[107.65%] left-[-15.76%] max-w-none top-[-22.25%] w-[174.61%]"
              src={imgRectangle23}
            />
          </div>
        </div>
      ...
      <div className="h-[606px] relative shrink-0 w-[560px]">
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <img
              alt=""
              className="absolute h-[131.22%] left-[-28.27%] max-w-none top-[-31.58%] w-[184.51%]"
              src={imgRectangle24}
            />
          </div>
          <div className="absolute inset-0 overflow-hidden">
            <img
              alt=""
              className="absolute h-[102.99%] left-[26.24%] max-w-none top-[-14.03%] w-[83.54%]"
              src={imgRectangle25}
            />
          </div>
        </div>
      ...
      <div className="h-[606px] relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-[560px]">
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <img
              alt=""
              className="absolute h-[152.02%] left-[-41.19%] max-w-none top-[-42.44%] w-[213.75%]"
              src={imgRectangle24}
            />
          </div>
        </div>
    ...
    <div className="flex items-center justify-center relative shrink-0 size-[24px]">
      <div className="flex-none rotate-90">
        <div
          ...
          data-name="bitcoin-icons:arrow-up-outline"
        >
          <svg
            className="absolute block inset-0 size-full"
            fill="none"
    ...
    <CollectionContext.Provider value={{ ...COLLECTIONS_DATA[currentIndex], currentIndex, direction }}>
      ...
      >
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          ...
          >
            <img src={imgCollection} className="absolute inset-0 w-full h-full object-cover" alt="collection background" />
          </div>
          <div
            className="absolute h-full top-0 overflow-hidden"
            style={{
...
function Frame1() {
  return (
    <label className="content-stretch flex items-center gap-[12px] relative shrink-0 w-full cursor-pointer">
      <input
        type="checkbox"
        className="size-[24px] accent-[#383629] cursor-pointer"
      />
      ...
      >
        ...
        <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-full">
          ...
          <div className="content-stretch flex items-center gap-[12px] relative shrink-0 w-full">
            <input
              id="privacy-agree-desktop"
              required
              type="checkbox"
              name="entry.831169210"
              value="네"
              className="size-[24px] accent-[#383629] cursor-pointer shrink-0"
            />
          ...
          <div className="content-stretch flex items-start gap-[12px] relative shrink-0 w-full mt-[-10px]">
            ...
            />
            <input
              id="marketing-agree-desktop"
              type="checkbox"
              checked={isMarketingAgreed}
              onChange={(e) => setIsMarketingAgreed(e.target.checked)}
              className="size-[24px] accent-[#383629] cursor-pointer shrink-0 mt-[2px]"
            />
            <div className="[word-break:break-word] flex flex-col font-sans justify-start leading-[1.4] not-italic relative text-[#444429] text-[18px]">
              <label
                htmlFor="marketing-agree-desktop"
        ...
        <button
          type="submit"
          className="bg-[#383629] content-stretch flex h-[60px] items-center justify-center pb-[16px] px-[40px] pt-[15px] relative rounded-[30px] shrink-0 cursor-pointer hover:bg-black transition-colors"
        >
          <div className="[word-break:break-word] flex flex-col font-serif justify-center leading-[0] not-italic relative shrink-0 text-[24px] text-white whitespace-nowrap">
            <p className="leading-[normal]">Reservation</p>
          </div>
  ...
  return (
    ...
    >
      ...
      >
        <img
          alt=""
          className="absolute max-w-none object-cover size-full rounded-sm pointer-events-none"
...
function Frame56() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[168px]">
      <p className="[word-break:break-word] capitalize font-serif leading-[1.3] not-italic relative shrink-0 text-[#c1c4ad] text-[40px] tracking-[-0.8px] w-full">
        SNS
      </p>
      <Frame57 />
    </div>
...
function Logo1({ onClick }: { onClick?: () => void }) {
  return (
    <div
      className="h-[59px] relative shrink-0 w-[190px] cursor-pointer"
      data-name="logo"
      onClick={onClick}
    >
      <svg
      ...
      >
        <g clipPath="url(#clip0_1_336)" id="logo">
          ...
          />
          <path
            d={svgPaths.p15c6e900}
            fill="var(--fill-0, white)"
            id="Vector_5"
          />
          <g id="Group_2">
            <path
              d={svgPaths.p34c34000}
              fill="var(--fill-0, white)"
              id="Vector_6"
            />
            <path
              d={svgPaths.p1212a780}
              fill="var(--fill-0, white)"
              id="Vector_7"
            />
          </g>
          <path
            d={svgPaths.p1ac89a00}
            fill="var(--fill-0, white)"
            id="Vector_8"
          />
          <path
            d={svgPaths.p2e1d7200}
            fill="var(--fill-0, white)"
            id="Vector_9"
          />
        </g>
        ...
        <div className="absolute left-0 top-[100%] mt-4 flex flex-col gap-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 pointer-events-none group-hover:pointer-events-auto bg-black/40 backdrop-blur-md px-[32px] py-[28px] rounded-2xl border border-white/10 shadow-xl min-w-[200px]">
          {["home", "brand", "Services", "Reservation"].map((item) => (
            <a
              ...
              className="font-dream capitalize text-white hover:text-[#bdbea7] transition-colors text-[24px] tracking-[-0.48px] cursor-pointer"
            >
              {item}
            </a>
          ))}
...
function Nav() {
  return (
    <div
      className="absolute bg-[rgba(0,0,0,0)] left-0 top-0 w-[1920px] z-[100]"
      data-name="nav"
    >
      ...
      <div
        aria-hidden
        className="absolute border border-[rgba(255,255,255,0)] border-solid inset-0 pointer-events-none"
      />
    </div>
  );
}
